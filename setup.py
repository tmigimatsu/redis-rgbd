...
setuptools.setup(
    ...
    description="Python redis-rgbd library",
    url="https://github.com/tmigimatsu/redis-rgbd",
    license="MIT",
    packages=["redisrgbd"],
    classifiers=[
    ...
    python_requires=">=3.6",
    ext_modules=[CMakeExtension("redisrgbd")],
    cmdclass={
